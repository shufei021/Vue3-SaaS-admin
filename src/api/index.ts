...
export async function getRevenueTrend(): Promise<
  ApiResponse<typeof mockRevenueTrend>
> {
  await delay();
  return success(mockRevenueTrend);
}

export async function getTenantDistribution(): Promise<
  ApiResponse<typeof mockTenantDistribution>
> {
  await delay();
...
export async function getTenantList(
  query?: PageQuery,
): Promise<ApiResponse<PageResult<TenantInfo>>> {
  await delay();
...
export async function getAnalyticsData(): Promise<
  ApiResponse<typeof mockAnalyticsData>
> {
  await delay();
